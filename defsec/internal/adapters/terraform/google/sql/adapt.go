...
func Adapt(modules terraform2.Modules) sql2.SQL {
	return sql2.SQL{
		Instances: adaptInstances(modules),
	}
}

func adaptInstances(modules terraform2.Modules) []sql2.DatabaseInstance {
	var instances []sql2.DatabaseInstance
...
func adaptInstance(resource *terraform2.Block) sql2.DatabaseInstance {

	instance := sql2.DatabaseInstance{
		...
		Settings: sql2.Settings{
			...
			Backups: sql2.Backups{
				Metadata: resource.GetMetadata(),
				Enabled:  types2.BoolDefault(false, resource.GetMetadata()),
			},
			IPConfiguration: sql2.IPConfiguration{
				Metadata:           resource.GetMetadata(),
...
//nolint
func adaptFlags(resources terraform2.Blocks, flags *sql2.Flags) {
...
func adaptIPConfig(resource *terraform2.Block) sql2.IPConfiguration {
